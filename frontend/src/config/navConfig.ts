...
export const ADMIN_NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/admin/drafts', i18nKey: 'admin.panel.tabs.drafts' },
...
export function getAdminGroupForPath(pathname: string): string | null {
  ...
  const leagueSetup = ['/admin/wrestlers', '/admin/companies', '/admin/shows', '/admin/drafts', '/admin/divisions', '/admin/seasons', '/admin/season-awards', '/admin/championships', '/admin/tournaments'];
